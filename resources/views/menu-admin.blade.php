<div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4 ">
    ...
    <p class="text-slate-400 text-sm mb-2">Bienvenido,</p>
    <a href="#"
        ...
        <div>
            <p class="font-medium group-hover:text-indigo-400 leading-4">Diego Chavez</p>
            <span class="text-xs text-slate-400">Inkasex S.A.C.</span>
        </div>
    </a>
            ...
            <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                ...
                <div>
                    <p class="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">
                        Dashboard</p>
                    <p class="text-slate-400 text-sm hidden md:block">Estadisticas</p>
                </div>
            </div>
        </a>
